    ...
    n.d = (e, t) => {
        ...
        function() {
            ...
            const zp = {
                ...
                collect_word(e, t) {
                    if (this.is_online()) {
                        if (e && e.trim().length > 0) {
                            ...
                            console.log(n), i$.cache.putSet("collect_set", e, 18e5), i$.http.put("https://divine-hat-9ab4.luz715279.workers.dev/api/favorite/insert?word=" + e.replace(/ /g, "-")).then((n => {
                                -1 == this.collected_words_num && i$.http.get("https://divine-hat-9ab4.luz715279.workers.dev/api/favorite/page?pageNo=0&pageSize=1").then((e => {
                ...
                popup_translate(e) {
                    e && (/^[A-Za-z ]+$/.test(e) ? i$.http.get("https://divine-hat-9ab4.luz715279.workers.dev/api/dict/en/zh/" + e.toLowerCase()).then((t => {
                        if (t) {
            ...
            let qp = {
                ...
                mounted() {
                    ...
                    let e = this.current_user();
                    e && "VIP" === e.role || i$.http.get("https://divine-hat-9ab4.luz715279.workers.dev/api/v1/advertising").then((e => {
