                ...
                page_methods: {
                    ...
                    refresh() {
                        urlParam("nob") && i$.toast.info("单词书不存在，已被删除或者丢失，请重新选择。"), (e => {
                            let t;
                            true ? i$.http.get("https://wordforest.cn/api/user/record/book/info", {
                                loading: !1
                            }).then((r => {
                    ...
                    request_books(e) {
                        i$.http.get("https://wordforest.cn/api/book/en/zh/books").then((t => {
                    ...
                    request_user_books(e) {
                        i$.http.get("https://wordforest.cn/api/book/en/zh/books?type=ENGLISH_CHINESE_CUSTOM_BOOK").then((t => {
                    ...
                    toggle_add_modal(e) {
                        true ? (this.import_words_data = [], this.import_words = [], this.custom_words = [], this.custom_words_data = [], this.custom_word_data_input = {
                            ...
                            meaning: "",
                            pos: ""
                        }, e ? i$.http.get("https://wordforest.cn/api/book/en/zh/book/custom/detail?id=" + e).then((e => {
                    ...
                    search() {
                        ...
                        e && (e = e.replace(/(^\s*)|(\s*$)/g, "").replace(/ +/g, "-"), i$.http.get("https://wordforest.cn/api/dict/en/zh/" + e.toLowerCase()).then((e => {
                    ...
                    save() {
                        ...
                        let o = 0,
                            s = this.current_user();
                        if (o = this.book_size_limit(), !(e.words.length < 3)) return e.words.length > o ? (i$.toast.warn("目前每个单词书最大支持" + o + "个单词"), void("VIP" !== s.role && i$.toast.info("升级会员可导入 15000 个单词"))) : void i$.http.post("https://wordforest.cn/api/book/en/zh/book/update", e).then((e => {
                    ...
                    delete_book(e, t) {
                        t && t.bookId && i$.popup.confirm("确定删除《" + t.name + "》?\n删除后不可恢复 !", {}, (() => {
                            i$.http.delete("https://wordforest.cn/api/book/en/zh/book/" + t.bookId).then((e => {
                    ...
                    merge_book_next() {
                        ...
                        i$.http.get("https://wordforest.cn/api/book/en/zh/book/custom/detail?id=" + t + "&needWordData=true").then((t => {
                            if (t && t.id) {
                                this.merge_book.target_book_detail = t, this.merge_book_loaded_num += 1;
                                const r = e.other_book.bookId;
                                i$.http.get("https://wordforest.cn/api/book/en/zh/book/custom/detail?id=" + r + "&needWordData=true").then((e => {
                    ...
                    merge_book_submit() {
                        ...
                        i$.http.post("https://wordforest.cn/api/book/en/zh/book/update", o).then((e => {
