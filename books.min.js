...
(() => {
    var e = {
            4809: function(e, t) {
                ...
                i = [], r = function e() {
                    ...
                    var t = "undefined" != typeof self ? self : "undefined" != typeof window ? window : void 0 !== t ? t : {},
                        ...
                        n = {
                            parse: function(r, i) {
                                ...
                                if (v(a) && (i.dynamicTypingFunction = a, a = {}), i.dynamicTyping = a, i.transform = !!v(i.transform) && i.transform, i.worker && n.WORKERS_SUPPORTED) {
                                    var d = function() {
                                        ...
                                        var r, i, a = (r = t.URL || t.webkitURL || null, i = e.toString(), n.BLOB_URL || (n.BLOB_URL = r.createObjectURL(new Blob(["var global = (function() { if (typeof self !== 'undefined') { return self; } if (typeof window !== 'undefined') { return window; } if (typeof global !== 'undefined') { return global; } return {}; })(); global.IS_PAPA_WORKER=true; ", "(", i, ")();"], {
                                            ...
                                            d = new t.Worker(a);
                                        return d.onmessage = g, d.id = s++, o[d.id] = d
                                    }();
                                    return d.userStep = i.step, d.userChunk = i.chunk, d.userComplete = i.complete, d.userError = i.error, i.step = v(i.step), i.chunk = v(i.chunk), i.complete = v(i.complete), i.error = v(i.error), delete i.worker, void d.postMessage({
                                        input: r,
                                        config: i,
                                        workerId: d.id
                                    })
                                ...
                                var c = null;
                                return n.NODE_STREAM_INPUT, "string" == typeof r ? (r = function(e) {
                                    return 65279 === e.charCodeAt(0) ? e.slice(1) : e
                                }(r), c = i.download ? new h(i) : new u(i)) : !0 === r.readable && v(r.read) && v(r.on) ? c = new _(i) : (t.File && r instanceof File || r instanceof Object) && (c = new l(i)), c.stream(r)
                            },
                            unparse: function(e, t) {
                                ...
                                ! function() {
                                    if ("object" == typeof t) {
                                        ...
                                        void 0 !== t.escapeChar && (d = t.escapeChar + a), ("boolean" == typeof t.escapeFormulae || t.escapeFormulae instanceof RegExp) && (u = t.escapeFormulae instanceof RegExp ? t.escapeFormulae : /^[=+\-@\t\r].*$/)
                                    }
                                }();
                                ...
                                } else if ("object" == typeof e) return "string" == typeof e.data && (e.data = JSON.parse(e.data)), Array.isArray(e.data) && (e.fields || (e.fields = e.meta && e.meta.fields || l), e.fields || (e.fields = Array.isArray(e.data[0]) ? e.fields : "object" == typeof e.data[0] ? Object.keys(e.data[0]) : []), Array.isArray(e.data[0]) || "object" == typeof e.data[0] || (e.data = [e.data])), c(e.fields || [], e.data || [], h);
                                ...
                                function c(e, t, r) {
                                    ...
                                    var a = Array.isArray(e) && 0 < e.length,
                                        d = !Array.isArray(t[0]);
                                    if (a && i) {
                                        for (var h = 0; h < e.length; h++) 0 < h && (n += o), n += p(e[h], h);
                                        0 < t.length && (n += s)
                                    }
                                ...
                                function p(e, t) {
                                    ...
                                    return (i = i || !0 === r || "function" == typeof r && r(e, t) || Array.isArray(r) && r[t] || function(e, t) {
                            ...
                            function o() {
                                if (0 !== i.length) {
                                    ...
                                    if (v(e.before)) {
                                        ...
                                        if ("object" == typeof l) {
                                            if ("abort" === l.action) return t = "AbortError", r = h.file, o = h.inputElem, d = l.reason, void(v(e.error) && e.error({
                                                name: t
                                            }, r, o, d));
                        ...
                        this._handle = null, this._finished = !1, this._completed = !1, this._halted = !1, this._input = null, this._baseIndex = 0, this._partialLine = "", this._rowCount = 0, this._start = 0, this._nextChunk = null, this.isFirstChunk = !0, this._completeResults = {
                            ...
                            function(e) {
                                ...
                                if (!this._handle.paused() && !this._handle.aborted()) {
                                    var d = a.meta.cursor;
                                    this._finished || (this._partialLine = s.substring(d - this._baseIndex), this._baseIndex = d), a && a.data && (this._rowCount += a.data.length);
                                    ...
                                    return this._config.step || this._config.chunk || (this._completeResults.data = this._completeResults.data.concat(a.data), this._completeResults.errors = this._completeResults.errors.concat(a.errors), this._completeResults.meta = a.meta), this._completed || !h || !v(this._config.complete) || a && a.meta.aborted || (this._config.complete(this._completeResults, this._input), this._completed = !0), h || a && a.meta.paused || this._nextChunk(), a
                                }
                                this._halted = !0
                    ...
                    function h(e) {
                        var t;
                        (e = e || {}).chunkSize || (e.chunkSize = n.RemoteChunkSize), d.call(this, e), this._nextChunk = r ? function() {
                    ...
                    function l(e) {
                        var t, r;
                        (e = e || {}).chunkSize || (e.chunkSize = n.LocalChunkSize), d.call(this, e);
                        var i = "undefined" != typeof FileReader;
                        this.stream = function(e) {
                            this._input = e, r = e.slice || e.webkitSlice || e.mozSlice, i ? ((t = new FileReader).onload = b(this._chunkLoaded, this), t.onerror = b(this._chunkError, this)) : t = new FileReaderSync, this._nextChunk()
                    ...
                    function c(e) {
                        ...
                        if (v(e.step)) {
                            ...
                            e.step = function(t) {
                                if (m = t, x()) y();
                                    ...
                                    l += t.data.length, e.preview && l > e.preview ? r.abort() : (m.data = m.data[0], w(m, h))
                                }
                            }
                        }
                        ...
                        function y() {
                            return m && i && (S("Delimiter", "UndetectableDelimiter", "Unable to auto-detect delimiting character; defaulted to '" + n.DefaultDelimiter + "'"), i = !1), e.skipEmptyLines && (m.data = m.data.filter((function(e) {
                                    return !b(e)
                                }))), x() && function() {
                                    if (m)
                                    ...
                                    function r(t, r) {
                                        v(e.transformHeader) && (t = e.transformHeader(t, r)), g.push(t)
                                    }
                                }(),
                                function() {
                                    ...
                                    function t(t, r) {
                                        ...
                                        for (i = 0; i < t.length; i++) {
                                            var s = i,
                                                n = t[i];
                                            e.header && (s = i >= g.length ? "__parsed_extra" : g[i]), e.transform && (n = e.transform(n, s)), n = E(s, n), "__parsed_extra" === s ? (o[s] = o[s] || [], o[s].push(n)) : o[s] = n
                                        }
                                        return e.header && (i > g.length ? S("FieldMismatch", "TooManyFields", "Too many fields: expected " + g.length + " fields but parsed " + i, u + r) : i < g.length && S("FieldMismatch", "TooFewFields", "Too few fields: expected " + g.length + " fields but parsed " + i, u + r)), o
                                    }
                                    var r = 1;
                                    return !m.data.length || Array.isArray(m.data[0]) ? (m.data = m.data.map(t), r = m.data.length) : m.data = t(m.data, 0), e.header && m.meta && (m.meta.fields = g), u += r, m
                                }()
                        }
                        ...
                        function S(e, t, r, i) {
                            ...
                            void 0 !== i && (o.row = i), m.errors.push(o)
                        }
                        this.parse = function(o, s, a) {
                            ...
                            if (e.newline || (e.newline = function(e, t) {
                                ...
                                var h = function(t, r, i, o, s) {
                                    ...
                                    for (var u = 0; u < s.length; u++) {
                                        ...
                                        for (var m = new p({
                                                ...
                                                newline: r,
                                                preview: 10
                                            }).parse(t), w = 0; w < m.data.length; w++)
                                            if (i && b(m.data[w])) g++;
                                            else {
                                                var k = m.data[w].length;
                                                f += k, void 0 !== h ? 0 < k && (c += Math.abs(k - h), h = k) : h = k
                                            } 0 < m.data.length && (f /= m.data.length - g), (void 0 === d || c <= d) && (void 0 === l || l < f) && 1.99 < f && (d = c, a = _, l = f)
                                    }
                                    return {
                                ...
                                h.successful ? e.delimiter = h.bestDelimiter : (i = !0, e.delimiter = n.DefaultDelimiter), m.meta.delimiter = e.delimiter
                            }
                            var l = k(e);
                            return e.preview && e.header && l.preview++, t = o, r = new p(l), m = r.parse(t, s, a), y(), _ ? {
                                meta: {
                                    paused: !0
                                }
                            } : m || {
                            ...
                            _ = !0, r.abort(), t = v(e.chunk) ? "" : t.substring(r.getCharIndex())
                        }, this.resume = function() {
                            h.streamer._halted ? (_ = !1, h.streamer.parseChunk(t, !0)) : setTimeout(h.resume, 3)
                        }, this.aborted = function() {
                            return c
                        }, this.abort = function() {
                            c = !0, r.abort(), m.meta.aborted = !0, v(e.complete) && e.complete(m), t = ""
                        }
                    }
                    ...
                    function p(e) {
                        ...
                        if (void 0 !== e.escapeChar && (h = e.escapeChar), ("string" != typeof r || -1 < n.BAD_DELIMITERS.indexOf(r)) && (r = ","), o === r) throw new Error("Comment character same as delimiter");
                        !0 === o ? o = "#" : ("string" != typeof o || -1 < n.BAD_DELIMITERS.indexOf(o)) && (o = !1), "\n" !== i && "\r" !== i && "\r\n" !== i && (i = "\n");
                        var l = 0,
                            u = !1;
                        this.parse = function(n, _, c) {
                            ...
                            if (d || !1 !== d && -1 === n.indexOf(t)) {
                                for (var z = n.split(i), L = 0; L < z.length; L++) {
                                    ...
                                    if (!o || x.substring(0, w) !== o) {
                                        ...
                                        if (a && a <= L) return b = b.slice(0, a), K(!0)
                                    }
                                }
                                return K()
                            }
                            for (var F = n.indexOf(r, l), j = n.indexOf(i, l), P = new RegExp(f(h) + f(t), "g"), M = n.indexOf(t, l);;)
                                if (n[l] !== t)
                                    if (o && 0 === x.length && n.substring(l, l + w) === o) {
                                        if (-1 === j) return K();
                                        l = j + m, j = n.indexOf(i, l), F = n.indexOf(r, l)
                                    } else if (-1 !== F && (F < j || -1 === j)) x.push(n.substring(l, F)), l = F + g, F = n.indexOf(r, l);
                            else {
                                if (-1 === j) break;
                                ...
                                for (M = l, l++;;) {
                                    ...
                                    if (t !== h || n[M + 1] !== h) {
                                        if (t === h || 0 === M || n[M - 1] !== h) {
                                            -1 !== F && F < M + 1 && (F = n.indexOf(r, M + 1)), -1 !== j && j < M + 1 && (j = n.indexOf(i, M + 1));
                                            var q = B(-1 === j ? F : Math.min(F, j));
                                            if (n.substr(M + 1 + q, g) === r) {
                                                x.push(n.substring(l, M).replace(P, t)), n[l = M + 1 + q + g] !== t && (M = n.indexOf(t, l)), F = n.indexOf(r, l), j = n.indexOf(i, l);
                                                break
                                            }
                                            var N = B(j);
                            ...
                            function W(e) {
                                return c || (void 0 === e && (e = n.substring(l)), x.push(e), l = p, U(x), k && H()), K()
                            }

                            function J(e) {
                                l = e, U(x), x = [], j = n.indexOf(i, l)
                            }
                    ...
                    function m(e, t) {
                        var r = o[e];
                        v(r.userComplete) && r.userComplete(t), r.terminate(), delete o[e]
                    }
                    ...
                    }), (h.prototype = Object.create(d.prototype)).constructor = h, (l.prototype = Object.create(d.prototype)).constructor = l, (u.prototype = Object.create(u.prototype)).constructor = u, (_.prototype = Object.create(d.prototype)).constructor = _, n
    ...
    r.n = e => {
        ...
        const i = {
                ...
                page_methods: {
                    init() {
                        let e = localStorage.getItem("$$words_custom_add_backward");
                        !1 !== e && "false" !== e || (this.words_custom_add_backward = !1), this.refresh()
                    },
                    refresh() {
                        urlParam("nob") && i$.toast.info("单词书不存在，已被删除或者丢失，请重新选择。"), (e => {
                            let t;
                            true ? i$.http.get("https://divine-hat-9ab4.luz715279.workers.dev/api/user/record/book/info", {
                                loading: !1
                            }).then((r => {
                                if (r && r.total && r.total > 0 ? (t = {
                                    ...
                                    let i = "/book?id=" + t.id;
                                    r.type ? i += "&type=" + r.type : i += "&type=DEFAULT", t.addr = i, e(t)
                                }
                            })).catch((t => {
                                "function" == typeof e && e(t)
                            })) : (t = i$.cache.get("book_info")) ? "function" == typeof e && e(t) : "function" == typeof e && e(null)
                        })((e => {
                            this.book_info = e, this.request_books(e), this.request_user_books(e)
                        }))
                    },
                    request_books(e) {
                        i$.http.get("https://divine-hat-9ab4.luz715279.workers.dev/api/book/en/zh/books").then((t => {
                            ...
                            n && i.unshift(n);
                            for (let e in i) r = i[e], s.push(o(r));
                            this.book_objs = s
                        }))
                    },
                    request_user_books(e) {
                        i$.http.get("https://divine-hat-9ab4.luz715279.workers.dev/api/book/en/zh/books?type=ENGLISH_CHINESE_CUSTOM_BOOK").then((t => {
                            if (t instanceof Array) {
                                let r, i = [];
                                for (let o in t) r = t[o], i.push({
                                    bookId: r.id,
                                    name: r.name,
                                    total: r.total,
                    ...
                    toggle_add_modal(e) {
                        true ? (this.import_words_data = [], this.import_words = [], this.custom_words = [], this.custom_words_data = [], this.custom_word_data_input = {
                            word: "",
                            meaning: "",
                            pos: ""
                        }, e ? i$.http.get("https://divine-hat-9ab4.luz715279.workers.dev/api/book/en/zh/book/custom/detail?id=" + e).then((e => {
                            ...
                            name: "",
                            words: []
                        }, this.add_type = 0), this.add_modal_show = !this.add_modal_show, this.add_modal_show || this.request_user_books(this.book_info)) : null
                    },
                    close_add_modal() {
                    ...
                    toggle_merge_modal() {
                        true ? (this.merge_book_start = !1, this.merge_modal_show ? this.merge_modal_show = !1 : (this.merge_book_clear(), this.merge_modal_show = !0)) : null
                    },
                    ...
                    select_file() {
                        ...
                        if (e) {
                            ...
                            this.import_words_data = [], this.import_words = [];
                            const t = e.name;
                    ...
                    remove_word(e) {
                        ...
                        e >= 0 && e < t.length && this.user_book.words.splice(e, 1), this.user_book.words.length <= this.words_collapse_max && (this.words_collapse = !1)
                    },
                    add_from_import() {
                        let e = this.import_words;
                        if (!e || 0 == e.length) return void i$.toast.info("先导入文件");
                        (new Date).getTime();
                        let t = this.user_book.words || [],
                        ...
                        if (t = !0 === r || "true" === r ? t.concat(e) : e.concat(t), document.getElementById("wordsFile").value = "", this.user_book.words = this.duplicate(t), this.import_words = [], this.import_words_data && this.import_words_data.length > 0) {
                            ...
                            this.new_words_data = e.concat(this.import_words_data), this.import_words_data = []
                        }
                    },
                    clear_import() {
                        this.import_words = [], document.getElementById("wordsFile").value = ""
                    },
                    add_from_search() {
                        if (this.search_word && this.search_word.id) {
                            ...
                            for (let r in t)
                                if (e == t[r]) {
                                    i$.toast.warn("单词书中已存在单词：" + e), e = "";
                                    break
                                } if (e) {
                                let t = this.words_custom_add_backward;
                                !0 === t || "true" === t ? this.user_book.words.push(e) : this.user_book.words.unshift(e), this.search_word = {
                                    word: ""
                                }
                            }
                        }
                    ...
                    add_from_custom() {
                        ...
                        if (t = !0 === r || "true" === r ? t.concat(e) : e.concat(t), this.user_book.words = this.duplicate(t), this.custom_words_data && this.custom_words_data.length > 0) {
                            let e = this.new_words_data || [];
                            this.new_words_data = e.concat(this.custom_words_data), this.custom_words_data = []
                        }
                        console.log(JSON.parse(JSON.stringify(e))), console.log(JSON.parse(JSON.stringify(this.custom_words_data))), this.custom_words = []
                    },
                    ...
                    add_custom_word() {
                        ...
                        s ? s.meanings[r] ? (s.meanings[r] += ";" + i, s.meanings[r].replaceAll(";+", ";")) : s.meanings[r] = i : (s = {
                            word: t,
                            meanings: {}
                        }, s.meanings[r] = i, this.custom_words.push(s.word), this.custom_words_data.push(s)), this.custom_word_data_input.word = "", this.custom_word_data_input.meaning = ""
                    },
                    duplicate(e) {
                        let t, r = [],
                            i = {};
                        const o = [];
                        for (let s in e) t = e[s], i[t] ? o.push(t) : (i[t] = !0, r.push(t));
                        return o.length > 0 && i$.toast.warn("有“" + o.length + "”个单词重复，已移除。"), r
                    },
                    sort_book_words() {
                        let e = this.duplicate(this.user_book.words);
                        e.sort(((e, t) => e > t ? 1 : e < t ? -1 : 0)), this.user_book.words = e
                    },
                    random_book_words() {
                    ...
                    search() {
                        ...
                        e && (e = e.replace(/(^\s*)|(\s*$)/g, "").replace(/ +/g, "-"), i$.http.get("https://divine-hat-9ab4.luz715279.workers.dev/api/dict/en/zh/" + e.toLowerCase()).then((e => {
                    ...
                    remind() {
                        i$.toast.info("感谢反馈，我们会尽快处理。(●'◡'●)"), this.search_word = {
                            word: ""
                        }
                    },
                    save() {
                        ...
                        let t, r = this.new_words_data,
                            i = {};
                        for (let e = 0; e < r.length; e++) t = r[e], i[t.word] = t.meanings;
                        e.wordsData = i;
                        let o = 0,
                            s = this.current_user();
                        if (o = this.book_size_limit(), !(e.words.length < 3)) return e.words.length > o ? (i$.toast.warn("目前每个单词书最大支持" + o + "个单词"), void("VIP" !== s.role && i$.toast.info("升级会员可导入 15000 个单词"))) : void i$.http.post("https://divine-hat-9ab4.luz715279.workers.dev/api/book/en/zh/book/update", e).then((e => {
                            e && -1 != e.code ? i$.toast.info("保存成功！") : (i$.toast.warn(e.msg), e.msg.indexOf("limited to") && i$.toast.info("升级到赞助会员可以添加更多单词书")), this.new_words_data = [], this.toggle_add_modal(), this.request_user_books(this.book_info)
                        })).catch((e => {
                            console.log(e), this.toggle_add_modal()
                        }));
                    ...
                    delete_book(e, t) {
                        t && t.bookId && i$.popup.confirm("确定删除《" + t.name + "》?\n删除后不可恢复 !", {}, (() => {
                            i$.http.delete("https://divine-hat-9ab4.luz715279.workers.dev/api/book/en/zh/book/" + t.bookId).then((e => {
                    ...
                    read_text_File(e) {
                        ...
                        t.readAsText(e, "UTF-8"), t.onload = e => {
                            let t, r = e.target.result.replace(/[^a-zA-Z]+/gi, ",").split(","),
                                i = [];
                    ...
                    read_excel_file(e) {
                        ...
                        r.readAsArrayBuffer(e), r.onload = e => {
                            t.xlsx.load(e.target.result).then((e => {
                                ...
                                i$.load.finish(), this.import_words = i, this.import_words_data = o
                            })).catch((e => {
                                console.log(e)
                            }))
                        }, r.onerror = e => {
                    ...
                    read_csv_file(e) {
                        e && t().parse(e, {
                            ...
                            complete: (e, t) => {
                                ...
                                i$.load.finish(), this.import_words = i, this.import_words_data = r
                            },
                            error: () => {
                                i$.toast.warn("文件格式异常")
                            }
                    ...
                    process_excel_data(e) {
                        ...
                        for (let o = 0; o < t.length; o++)
                            for (r = t[o], i = -1;
                                (i = e.indexOf(r, i + 1)) >= 0;) n = !0, "v." === r && i > 0 && "d" === e[i - 1] || s.push({
                                pos: r,
                                index: i
                            });
                        ...
                        if (1 == s.length) o = {
                            ...
                            let t, r;
                            for (let i = 0; i < s.length - 1; i++) t = s[i], r = s[i + 1], null != (o = a[t.pos]) ? o.meaning += e.substring(t.index + t.pos.length, r.index) + ";" : (o = {
                                pos: t.pos,
                        ...
                        let d = [];
                        for (let e in a) o = a[e], o.meaning = o.meaning.replaceAll(/;+/g, ";").substring(0, 100), o.meaning.startsWith(";") && (o.meaning = o.meaning.substring(1)), d.push(o);
                        return d
                    },
                    next_import_words() {
                    ...
                    merge_book_clear() {
                        this.merge_book_type = "", this.merge_book = {
                            newname: "",
                            selecting: "",
                            target_book: {},
                            target_book_detail: {},
                    ...
                    merge_book_next() {
                        ...
                        this.merge_book_loaded_num = 0, this.merge_book_start = !0;
                        const t = e.target_book.bookId;
                        i$.http.get("https://divine-hat-9ab4.luz715279.workers.dev/api/book/en/zh/book/custom/detail?id=" + t + "&needWordData=true").then((t => {
                            if (t && t.id) {
                                this.merge_book.target_book_detail = t, this.merge_book_loaded_num += 1;
                                const r = e.other_book.bookId;
                                i$.http.get("https://divine-hat-9ab4.luz715279.workers.dev/api/book/en/zh/book/custom/detail?id=" + r + "&needWordData=true").then((e => {
                    ...
                    merge_book_submit() {
                        ...
                        this.current_user();
                        if (r + i > s) return i$.toast.warn("合并失败:目前每个单词书最大支持" + s + "个单词"), void i$.toast.info("赞助会员可导入 15000 个单词");
                        if ("new" == this.merge_book_type) {
                            o.id = null;
                            const e = this.book_num_limit();
                            if (this.user_books.length >= e) return i$.toast.warn("当前权限只能创建(" + e + ")个单词书"), void i$.toast.info("赞助会员可导入 15 个单词表");
                        ...
                        o.wordsData = o.wordsData || {}, t.wordsData = t.wordsData || {};
                        for (let e in t.wordsData) o.wordsData[e] = t.wordsData[e];
                        i$.http.post("https://divine-hat-9ab4.luz715279.workers.dev/api/book/en/zh/book/update", o).then((e => {
                            e && -1 != e.code ? i$.toast.info("合并成功！") : (i$.toast.warn(e.msg), e.msg.indexOf("limited to 3") && i$.toast.info("升级到赞助会员可以添加更多单词书")), this.request_user_books(this.book_info), this.merge_book_clear(), this.toggle_merge_modal()
                        })).catch((e => {
                            console.log(e), this.toggle_add_modal()
                        }))
                    }
